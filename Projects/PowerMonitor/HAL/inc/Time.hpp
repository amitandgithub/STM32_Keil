...
public:
    ...
    Time(unsigned char hrs, unsigned char min, unsigned char sec, unsigned int millis=0);
    ~Time(){};
    ...
    void Set(unsigned char hrs, unsigned char min, unsigned char sec, unsigned int millis = 0);
    bool Run();
private:
